...
create unique clustered index ix_messages on messages (msgid)
go
/* ============================================================ */
/*   Build foreign keys                                         */
/* ============================================================ */
...
INSERT INTO pbcatcol VALUES (
	'examples_categories_list',
	OBJECT_ID('dbo.examples_categories_list'),
	'dbo',
	'picture_idx',
	5,
	'Picture Idx:',
...
INSERT INTO pbcatcol VALUES (
	'sales_order_items',
	OBJECT_ID('dbo.sales_order_items'),
	'dbo',
	'id',
	1,
	'Sales Order ID:',
