InfoMaker[R] Version 12.0 Read Me First 
*********************************************************************
For last minute information, see the Release Bulletin on the Sybase 
Web site:

   1. Go to the Sybase Product Manuals Web site at 
      http://sybooks.sybase.com.
   2. Select InfoMaker and click Go.
   3. Select InfoMaker 12.0.
   4. Select the Release Bulletin.
   
**********************************************************************
(c) 1991-2010 Sybase, Inc. and its subsidiaries. All rights reserved. 
